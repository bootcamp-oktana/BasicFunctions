...
public class TestKodeIt extends Base{
    ...
    public void initialize() {
        ...
        //driver.get("https://learn.letskodeit.com/p/practice"); //every test navigates to the url
    ...
    public void testVerify() { //know as soft assert
        ...
        softAssert.assertEquals(expectedTitle1, actualTitle); //will pass
        softAssert.assertNotEquals(expectedTitle2, actualTitle); // will pass
        softAssert.assertEquals(expectedTitle2, actualTitle); //will fail

        //verifying the web page url
        softAssert.assertEquals(expectedURL1, actualURL); //will pass
        softAssert.assertNotEquals(expectedURL2, actualURL); //will pass
        softAssert.assertEquals(expectedURL2, actualURL);  //will fail
    ...
    public void testVisible(){
     ...
     @Test
     public void testDropDownSimple() throws InterruptedException {
         //initialize the soft assert object
         SoftAssert softAssert = new SoftAssert();
    ...
    @Test
    public void testDropDownMultiple() throws InterruptedException {
        //initialize the soft assert object
        SoftAssert softAssert = new SoftAssert();
